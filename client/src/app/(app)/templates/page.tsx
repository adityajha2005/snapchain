...
const TemplatesPage = () => {
	...
	const templates = [
		...
		},
		{
			...
			description:
				"A marketplace for buying, selling, and auctioning NFTs with royalty support",
			category: "NFT",
		...
		},
		{
			...
			description:
				"A decentralized autonomous organization with proposal and voting mechanisms",
			category: "Governance",
			complexity: "Intermediate",
			features: [
				"Proposal Creation",
		...
		},
		{
			...
			title: "ICO Platform",
			description:
				"An initial coin offering platform with vesting schedules and KYC integration",
		...
		},
		{
			...
			description:
				"Connect to multiple blockchain wallets with a unified interface",
		...
		},
		{
			...
			description:
				"Manage in-game assets as NFTs with trading and marketplace capabilities",
			category: "Gaming",
			complexity: "Advanced",
			...
			{filteredTemplates.length === 0 && (
				<div className="text-center py-12 border border-border rounded-lg bg-card/50">
					...
					<p className="text-muted-foreground text-sm max-w-md mx-auto">
						No templates match your current search criteria. Try changing your
				...
				<div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4 relative z-10">
					<div>
						...
						<p className="text-sm text-muted-foreground mt-1">
							Can't find what you're looking for? Our team can build a custom
